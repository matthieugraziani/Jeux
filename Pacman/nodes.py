...
class NodeGroup(object):
    ...
    def readMazeFile(self, level):
        # Supprimez le "+ '.txt'" ici, car level est déjà "maze1.txt"
        textfile = level
        return np.loadtxt(os.path.join(os.path.dirname(__file__), textfile), dtype='<U1')  # Utilisez le chemin absolu comme précédemment suggéré
