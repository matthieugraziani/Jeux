...
class Spritesheet(object):
    def __init__(self):
        self.sheet = pygame.image.load("./Matt/Python/Jeux/Pacman/spritesheet_mspacman.png").convert()
...
class MazeSprites(Spritesheet):
    ...
    def readMazeFile(self, mazefile):
        return np.loadtxt(os.path.join(os.path.dirname(__file__), mazefile), dtype='<U1')  # Modifiez cette ligne pour utiliser un chemin absolu basé sur le répertoire du fichier
